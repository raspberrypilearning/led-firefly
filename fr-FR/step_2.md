...
Tu trouveras de plus amples informations dans le [Guide Raspberry Pi Pico](https://projects.raspberrypi.org/fr-FR/projects/introduction-to-the-pico){:target="_blank"}.
